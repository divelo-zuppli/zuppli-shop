/* 5bdefd1c22bb356f8ed39c0b828393171ea2e082
...
export declare type ChangeUserPasswordMutationVariables = Types.Exact<{
  authUid: Types.Scalars['String'];
  oldPassword: Types.Scalars['String'];
  newPassword: Types.Scalars['String'];
}>;
export declare type ChangeUserPasswordMutation = {
  __typename?: 'Mutation';
  changeUserPassword: {
    __typename?: 'User';
    id: number;
...
export declare const ChangeUserPasswordDocument: Apollo.DocumentNode;
export declare type ChangeUserPasswordMutationFn = Apollo.MutationFunction<ChangeUserPasswordMutation, ChangeUserPasswordMutationVariables>;
/**
...
export declare function useChangeUserPasswordMutation(baseOptions?: Apollo.MutationHookOptions<ChangeUserPasswordMutation, ChangeUserPasswordMutationVariables>): Apollo.MutationTuple<ChangeUserPasswordMutation, Types.Exact<{
  authUid: string;
  oldPassword: string;
  newPassword: string;
}>, Apollo.DefaultContext, Apollo.ApolloCache<any>>;
export declare type ChangeUserPasswordMutationHookResult = ReturnType<typeof useChangeUserPasswordMutation>;
export declare type ChangeUserPasswordMutationResult = Apollo.MutationResult<ChangeUserPasswordMutation>;
export declare type ChangeUserPasswordMutationOptions = Apollo.BaseMutationOptions<ChangeUserPasswordMutation, ChangeUserPasswordMutationVariables>;
